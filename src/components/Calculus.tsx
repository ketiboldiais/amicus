...
import squeeze_theorem from "../../public/diagrams/squeeze_theorem.svg";
...
export const SQUEEZE_THEOREM = () => (
  <Img width={250} url={squeeze_theorem} alt="Squeeze theorem curves." />
);
